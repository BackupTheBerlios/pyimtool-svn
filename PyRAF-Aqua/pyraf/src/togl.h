/* $Id: togl.h,v 1.1 2003/10/08 18:39:44 dencheva Exp $ */
...
/*
    * $Log: togl.h,v $
    * Revision 1.1  2003/10/08 18:39:44  dencheva
    * Restructuring  PyRAF to look more like a Python package and to use Distutils
    *
    * Revision 1.1  2001/06/25 13:00:51  dencheva
    * Adding the GNU Autoconfig stuff to build
    *
    * Revision 1.1  2000/04/18 14:48:15  perry
    * *** empty log message ***
    *
